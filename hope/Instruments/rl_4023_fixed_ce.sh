...
usage() {
  cat <<'EOF'
Usage:
  bash rl_4023_fixed_ce.sh [--ds-config <path>] [--dry-run]
...
OUTPUT_DIR="${REPO_ROOT}/rl_outputs/Instruments-grec-lc4023-fixed-ce"
...
RUN_NAME="instruments_grec_lc4023_fixed_ce"
