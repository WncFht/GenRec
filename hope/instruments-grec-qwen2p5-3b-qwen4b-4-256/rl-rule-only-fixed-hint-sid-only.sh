...
usage() {
  cat <<'EOF'
Usage:
  bash rl-rule-only-fixed-hint-sid-only.sh [--ds-config <path>] [--dry-run]
...
DATA_VARIANT_DEFAULT="Instruments_grec_rlsidonly_index_emb-qwen3-embedding-4B_rq4_cb256-256-256-256_dsInstruments_ridFeb-10-2026-05-40-47"
...
OUTPUT_DIR="${REPO_ROOT}/rl_outputs/Instruments-grec-grpo-rule-only-fixedhint-taskfix-b16-sid-only-sft495"
