...
usage() {
  cat <<'EOF'
Usage:
  bash Qwen2_5-3B-Instruct-qwen4B-4-64-MIMIGenRec-grec-rl.sh [options]
...
DATA_VARIANT_DEFAULT="${DATA_VARIANT_DEFAULT:-Instruments_grec_index_emb-qwen3-embedding-4B_rq4_cb64-64-64-64_dsInstruments_ridFeb-10-2026-06-04-11}"

# continue from provided SFT checkpoint-495 by default
MODEL_PATH="${MODEL_PATH:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/saves/qwen2.5-3b/full/Instruments-grec-sft-qwen4B-4-64-dsz0/checkpoint-495}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/rl_outputs/Instruments-grec-grpo-qwen2.5-3b-qwen4B-4-64-from-sft495}"
...
export WANDB_RUN_NAME="${WANDB_RUN_NAME:-instruments_grec_rl_qwen2_5_3b_qwen4b_4_64_from_ckpt495}"
