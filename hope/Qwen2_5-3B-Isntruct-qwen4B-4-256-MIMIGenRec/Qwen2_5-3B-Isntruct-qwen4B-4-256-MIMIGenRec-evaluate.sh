...
SFT_ROOT="${SFT_ROOT:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/saves/qwen2.5-3b/full/Instruments-sft-qwen4B-4-256-dsz0}"
TEST_DATA_PATH="${TEST_DATA_PATH:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/data/Instruments/sft/test.json}"
INDEX_PATH="${INDEX_PATH:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/data/Instruments/id2sid.json}"
...
#   CKPT_LIST="checkpoint-260 checkpoint-320"
#   CKPT_LIST="/abs/path/to/checkpoint-260 /abs/path/to/checkpoint-320"
