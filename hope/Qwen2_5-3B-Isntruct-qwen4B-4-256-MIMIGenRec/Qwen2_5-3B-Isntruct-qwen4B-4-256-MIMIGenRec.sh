...
YAML_PATH="${YAML_PATH:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/examples/train_full/Instruments/instruments_rec_full_sft_3b_dsz0_qwen4b_4_256.yaml}"
...
RUN_NAME="${RUN_NAME:-$(basename "${YAML_PATH%.yaml}")}"
