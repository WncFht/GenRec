...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Arts-grec-genrec-fixed-full-sequence-sft-from-sft}"
export RUN_NAME="${RUN_NAME:-arts_grec_genrec_fixed_full_sequence_sft_from_sft}"
