...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Instruments-grec-genrec-fixed-full-sequence-sft-from-sft}"
export RUN_NAME="${RUN_NAME:-instruments_grec_genrec_fixed_full_sequence_sft_from_sft}"
...
export FULL_SEQUENCE_SFT_LOSS_COEF="${FULL_SEQUENCE_SFT_LOSS_COEF:-0.001}"
