...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Instruments-grec-genrec-fixed-from-sft}"
export RUN_NAME="${RUN_NAME:-instruments_grec_genrec_fixed_from_sft}"
