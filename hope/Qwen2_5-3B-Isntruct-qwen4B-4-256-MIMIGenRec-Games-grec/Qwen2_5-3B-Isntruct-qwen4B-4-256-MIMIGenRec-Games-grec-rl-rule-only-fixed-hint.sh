...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Games-grec-grpo-rule-only-fixedhint-taskfix-b16-sft896}"
...
RUN_NAME="${RUN_NAME:-games_grec_rl_rule_only_fixed_hint_taskfix_b16_ckpt896}"
