...
usage() {
  cat <<'EOF'
Usage:
  bash Qwen2_5-3B-Isntruct-qwen4B-4-256-MIMIGenRec-mimionerec-rl.sh [options]
...
DATA_VARIANT_DEFAULT="${DATA_VARIANT_DEFAULT:-Instruments_mimionerec_index_emb-qwen3-embedding-4B_rq4_cb256-256-256-256_dsInstruments_ridFeb-10-2026-05-40-47}"

# continue from provided SFT checkpoint-495 by default
MODEL_PATH="${MODEL_PATH:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/saves/qwen2.5-3b/full/Instruments-mimionerec-sft-qwen4B-4-256-dsz0/checkpoint-495}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/rl_outputs/Instruments-mimionerec-grpo-qwen2.5-3b-qwen4B-4-256-from-sft495}"
DS_CONFIG="${DS_CONFIG:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/config/zero2.yaml}"

PYTHON_BIN="${PYTHON_BIN:-python}"
CATEGORY="${CATEGORY:-Instruments_mimionerec}"
...
export WANDB_RUN_NAME="${WANDB_RUN_NAME:-instruments_mimionerec_rl_qwen2_5_3b_qwen4b_4_256_from_ckpt495}"
