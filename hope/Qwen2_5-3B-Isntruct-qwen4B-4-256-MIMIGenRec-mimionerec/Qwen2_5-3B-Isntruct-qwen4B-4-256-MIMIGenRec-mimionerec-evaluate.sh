...
DATA_VARIANT_DEFAULT="Instruments_mimionerec_index_emb-qwen3-embedding-4B_rq4_cb256-256-256-256_dsInstruments_ridFeb-10-2026-05-40-47"
SFT_ROOT="${SFT_ROOT:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/saves/qwen2.5-3b/full/Instruments-mimionerec-sft-qwen4B-4-256-dsz0}"
...
export CATEGORY="${CATEGORY:-Instruments_mimionerec}"
