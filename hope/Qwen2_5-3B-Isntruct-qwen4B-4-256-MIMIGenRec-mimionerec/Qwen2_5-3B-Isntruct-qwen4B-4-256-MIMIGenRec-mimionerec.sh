...
YAML_PATH="${YAML_PATH:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/examples/train_full/Instruments/instruments_rec_full_sft_3b_dsz0_qwen4b_4_256_mimionerec.yaml}"
...
RUN_NAME="${RUN_NAME:-instruments_rec_full_sft_3b_dsz0_qwen4b_4_256_mimionerec}"
