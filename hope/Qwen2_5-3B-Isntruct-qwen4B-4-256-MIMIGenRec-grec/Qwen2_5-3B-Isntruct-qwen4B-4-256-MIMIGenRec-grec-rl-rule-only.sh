...
run_rl_variant_wrapper \
  --preset rule_only \
  --output-dir "${REPO_ROOT}/rl_outputs/Instruments-grec-grpo-rule-only-rerun-quietlog-qwen2.5-3b-qwen4B-4-256-from-sft495" \
  --run-name "instruments_grec_rl_rule_only_rerun_quietlog_qwen2_5_3b_qwen4b_4_256_from_ckpt495" \
  --port 29516 \
