...
usage() {
  cat <<'EOF'
Usage:
  bash Qwen2_5-3B-Isntruct-qwen4B-4-256-MIMIGenRec-grec-rl-prefix-token-totalnorm.sh [options]
...
OUTPUT_DIR="${OUTPUT_DIR:-/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GenRec/rl_outputs/Instruments-grec-grpo-prefix-tokenadv-totalnorm-ndcg-rule0-qwen2.5-3b-qwen4B-4-256-from-sft495}"
...
export WANDB_RUN_NAME="${WANDB_RUN_NAME:-instruments_grec_rl_prefix_tokenadv_totalnorm_ndcg_rule0_qwen2_5_3b_qwen4b_4_256_from_ckpt495}"
