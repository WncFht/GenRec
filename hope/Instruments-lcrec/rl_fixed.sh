...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Instruments-grec-lcrec-fixed-from-sft4023}"
export RUN_NAME="${RUN_NAME:-instruments_grec_lcrec_fixed_from_sft4023}"
