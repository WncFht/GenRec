...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Instruments-grec-lcrec-rule-from-sft4023}"
export RUN_NAME="${RUN_NAME:-instruments_grec_lcrec_rule_from_sft4023}"
export NUM_PROCESSES="${NUM_PROCESSES:-4}"
export MAIN_PORT="${MAIN_PORT:-29516}"
export REWARD_MODE="${REWARD_MODE:-rule_only}"
