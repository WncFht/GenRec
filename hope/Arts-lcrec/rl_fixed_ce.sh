...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/rl_outputs/Arts-grec-lcrec-fixed-ce-from-sft17268}"
export RUN_NAME="${RUN_NAME:-arts_grec_lcrec_fixed_ce_from_sft17268}"
